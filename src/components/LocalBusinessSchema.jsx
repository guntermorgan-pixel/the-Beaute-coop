...
export default function LocalBusinessSchema() {
  const schema = {
    ...
    description: `${business.name} is a beauty salon in ${business.address.city}, ${business.address.state} offering nail artistry, lash extensions, brow design, medical-grade skin care, and waxing from independent specialists. ${business.hours}.`,
